 ...
 * @LastEditTime: 2020-04-05 13:22:22
 -->
<template>
  <div id="shangpinxinxiList" class="myList">
    <ul>
      <li v-for="item in list" :key="item.id">
        ...
        <router-link :to="{ path: '/shangpinxinxidetail', query: {shangpinxinxiID:item.id} }">
          <img :src="`/api/`+item.tupian" alt />
          <h2>{{item.shangpinmingcheng}}</h2>
          <h3>{{item.shangpinleibie}}</h3>
          <p>
            <span>价格：{{item.jiage}}元</span>
            <span
