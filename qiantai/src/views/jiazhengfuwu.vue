...
<template>
  <div class="order">
    ...
    <div class='pro-img'> 类别</div>
    <div class='pro-img'> 服务价格</div>
    <div class='pro-img'> 服务时长</div>
    <div class='pro-img'> 图片</div>
          ...
          <li class="product-list" v-for="item in jiazhengfuwu" :key="item.id">
            <router-link :to="`/jiazhengfuwudetail/`+item.id" >
				<div class='pro-img'>{{item.fuwumingcheng}}</div>
    <div class='pro-img'>{{item.leibie}}</div>
    <div class='pro-img'>{{item.fuwujiage}}</div>
    <div class='pro-img'>{{item.fuwushichang}}</div>
